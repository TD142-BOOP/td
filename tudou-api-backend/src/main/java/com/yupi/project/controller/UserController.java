...
import com.yupi.project.model.dto.user.UserUpdateMyRequest;
...
import static com.yupi.project.service.impl.UserServiceImpl.SALT;
...
public class UserController {
     ...
     */
    @GetMapping("/get/vo")
    public BaseResponse<LoginUserVO> getUserVOById(long id, HttpServletRequest request) {
    ...
    public BaseResponse<UserDevKeyVO> getKey(HttpServletRequest request){
        ...
        ThrowUtils.throwIf(userServiceOne==null,ErrorCode.NOT_FOUND_ERROR);
        UserDevKeyVO userDevKeyVO = new UserDevKeyVO();
        userDevKeyVO.setAccessKey(userServiceOne.getAccessKey());
        userDevKeyVO.setSecretKey(userServiceOne.getSecretKey());
    ...
    public BaseResponse<Boolean> updateUserAvatar(@RequestParam(required = false) MultipartFile file, HttpServletRequest request){
        ...
        boolean result=userService.updateUserAvatar(file,request);
        return ResultUtils.success(result);
    }
